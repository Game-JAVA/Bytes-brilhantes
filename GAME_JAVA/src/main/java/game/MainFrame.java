...
public class MainFrame extends JFrame implements Runnable {
    ...
    public void run() {
        ...
        enemies.add(new Enemy(100, 12, 5, 0, "Vilão1",
                "img/Inimigo1.gif", 1000, 50, "sound/hit.wav"));
        enemies.add(new Enemy(100, 14, 5, 0, "Vilão2",
                "img/Inimigo2.gif", 1000, 50, "sound/hit.wav"));
        enemies.add(new Enemy(100, 16, 5, 0, "Vilão3",
                "img/Inimigo3.gif", 1000, 50, "sound/hit.wav"));
        enemies.add(new Boss(100 , 20, 5, 100, "Boss",
